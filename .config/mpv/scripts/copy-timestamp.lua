...
mp.add_key_binding("Ctrl+c", "copy-timestamp-formatted", function() copy_timestamp{ timestamp_format = 'formatted' } end)
mp.add_key_binding("Ctrl+C", "copy-timestamp-raw", function() copy_timestamp{ timestamp_format = 'raw' } end)
